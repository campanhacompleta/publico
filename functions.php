...
function publico_widgets_init() {
	...
	register_sidebar( array(
		...
		'before_widget' => '<aside id="%1$s" class="widget %2$s ' . publico_count_widgets('sidebar-social-engagement') . ' ">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h4 class="widget-title area__title">',
		'after_title'   => '</h4>',
	) );
	...
	register_sidebar( array(
		...
		'before_widget' => '<aside id="%1$s" class="widget %2$s ' . publico_count_widgets('sidebar-content-secondary') . ' ">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h4 class="widget-title area__title">',
		'after_title'   => '</h4>',
	) );
	...
	register_sidebar( array(
		...
		'description'   => '',
		'before_widget' => '<aside id="%1$s" class="widget %2$s ' . publico_count_widgets('sidebar-content-bottom') . ' ">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h4 class="widget-title area__title">',
		'after_title'   => '</h4>',
	) );
	...
	register_sidebar( array(
		...
		'id'            => 'sidebar-footer',
		'description'   => '',
		'before_widget' => '<aside id="%1$s" class="widget %2$s ' . publico_count_widgets('sidebar-footer') . ' ">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h4 class="widget-title area__title">',
		'after_title'   => '</h4>',
	) );
